      ...
      <Section title="Variants">
        ...
        >
          ...
          <motion.ul
            ...
            className="bg-blue-500 text-white py-2 rounded-sm flex flex-col justify-start text-left absolute top-8"
            variants={menuVariants}
          >
            <motion.li
              className="cursor-pointer px-10 border-2 border-transparent"
